...
const Login = () => {
  ...
  return (
    <section className="relative min-h-screen bg-banner bg-cover flex justify-center items-center">
      <div className="md:hero">
        <div className="hero-content">
          <div className="card flex-shrink-1 md:w-96 shadow-2xl bg-base-100 z-20 relative">
