const LoadingButton = ({ customClass }) => {
  return (
    <button
      type="button"
      disabled
      className={`inline-flex w-auto cursor-wait select-none appearance-none items-center justify-center space-x-2 rounded border bg-secondary px-3 py-2 text-sm font-medium text-white transition ${customClass}`}
    >
